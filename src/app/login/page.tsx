      ...
      <div className="auth-page__wrap">
        <header className="auth-header">
          <div className="auth-header__inner">
            ...
            <nav aria-label="Primary navigation" className="auth-nav">
            ...
            <div className="auth-actions">
              <button className="sale-pill">Sale</button>
          ...
          <div className="hero__content">
            <div className="relative grid w-full items-center lg:grid-cols-[minmax(0,1fr)_minmax(330px,420px)]">
              ...
              <div className="pointer-events-none relative z-10 h-[270px] sm:h-[380px] lg:col-start-1 lg:row-start-1 lg:h-[625px]">
                <span className="hero__deco-number">01</span>
              ...
              <div className="relative z-20 mt-4 w-full max-w-[420px] justify-self-center lg:mt-0 lg:justify-self-end">
                <div className="auth-card">
                  <div className="absolute right-8 top-8 flex gap-1" aria-hidden="true">
        ...
        <section aria-label="Live race timing" className="live-bar">
          <div className="live-bar__status"><span className="mr-3 h-4 w-4 rounded-full bg-[#ff1801] shadow-[0_0_12px_rgba(255,24,1,0.85)]" />Live</div>
          <div className="live-bar__data"><span>Lap 26 / 61</span><span className="text-white">VER 1:32.472</span><span>LEC +0.614</span><span>NOR +1.023</span><span className="text-[#ff1801]">Sprint qualifying</span></div>
        </section>
        ...
        <section className="border-b border-white/20 bg-[#050505] px-6 py-7 text-center sm:py-8">
          ...
          <div className="team-list"><span>Ferrari</span><span>McLaren</span><span>Mercedes</span><span>Red Bull Racing</span><span>Williams</span></div>
        </section>
      </div>
    </main>
  );
