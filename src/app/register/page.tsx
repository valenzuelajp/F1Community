...
/**
 * Formula 1 Register Page
 *
 * 1:1 mirror of the login shell (`src/app/login/page.tsx`):
 * - Same header, hero, telemetry, teams, tires, and footer.
 * - Only the auth card swaps LoginForm → RegisterForm, and the header
 *   pill points back to /login instead of /register.
 */
